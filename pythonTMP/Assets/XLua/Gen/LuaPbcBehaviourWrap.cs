...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPbcBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPbcBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaPbcBehaviour __cl_gen_ret = new LuaPbcBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPbcBehaviour constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                LuaPbcBehaviour __cl_gen_to_be_invoked = (LuaPbcBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                LuaPbcBehaviour __cl_gen_to_be_invoked = (LuaPbcBehaviour)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.injections = (InjectionPbc[])translator.GetObject(L, 2, typeof(InjectionPbc[]));
