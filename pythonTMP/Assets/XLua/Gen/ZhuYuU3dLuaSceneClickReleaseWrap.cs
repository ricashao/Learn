...
namespace XLua.CSObjectWrap
{
    ...
    public class ZhuYuU3dLuaSceneClickReleaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZhuYuU3d.LuaSceneClickRelease);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					ZhuYuU3d.LuaSceneClickRelease __cl_gen_ret = new ZhuYuU3d.LuaSceneClickRelease();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZhuYuU3d.LuaSceneClickRelease constructor!");
        ...
        static int _m_OnPointerDown(RealStatePtr L)
        {
		    try {
                ...
                ZhuYuU3d.LuaSceneClickRelease __cl_gen_to_be_invoked = (ZhuYuU3d.LuaSceneClickRelease)translator.FastGetCSObj(L, 1);
