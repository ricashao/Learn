...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaSocketBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaSocketBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaSocketBehaviour __cl_gen_ret = new LuaSocketBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaSocketBehaviour constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                LuaSocketBehaviour __cl_gen_to_be_invoked = (LuaSocketBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                LuaSocketBehaviour __cl_gen_to_be_invoked = (LuaSocketBehaviour)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.injections = (LuaSocketInjection[])translator.GetObject(L, 2, typeof(LuaSocketInjection[]));
