...
function RegisterPanelServices.Clear()

	er("C2S_RegisterModule_GoRegister",RegisterPanelServices.OnEvent);

	er("C2S_RegisterModule_GoBindUser",RegisterPanelServices.OnEvent);

	mr(sib(10000),RegisterPanelServices.on_msg)
