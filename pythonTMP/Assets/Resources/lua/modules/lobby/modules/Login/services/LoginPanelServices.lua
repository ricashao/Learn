...
function LoginPanelServices.Clear()

	er("C2S_LoginModule_LoginByPhoneID",LoginPanelServices.OnEvent);

	er("C2S_LoginModule_LoginByGuest",LoginPanelServices.OnEvent);

	mr(this.MsgCmd.SC_LoginSuccess,LoginPanelServices.OnNetMessage)
