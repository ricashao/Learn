...
local ModifyPasswordPanelView = {}
local this = ModifyPasswordPanelView
--初始化方法
function ModifyPasswordPanelView:init(transform)
...
--销毁方法
function ModifyPasswordPanelView:on_destroy()
	
	this.transform = nil

	print('ModifyPasswordPanelView:ondestroy!')
end
--视图状态
function ModifyPasswordPanelView:set_state(viewState)
	
	self.viewState = viewState

	print('>>> ModifyPasswordPanelView:setstate'..viewState)
	-- body
...
return ModifyPasswordPanelView